...
Tip: use the Python built-in functions: map(), sum(), min(), max(). Sample result:
[48, 54, 52, 51]
'''
lista = [(17,15,16,17,15),(16,18,19,17,19),(19,15,15,19,18),(18,17,19,15,16)]
new = list(map(lambda x: sum(x)-min(x)-max(x),lista))
print(new)